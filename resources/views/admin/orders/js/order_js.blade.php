<script>
    ...
    $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, customer) {
                            $('#customerList').append('<li class="dropdown-item">' + customer.customer_name + ' - ' + customer.phonenum + ' - ' + customer.customer_id + '</li>');
                        });
                        $('#customerList').show();
                    }
                });
        ...
        $(document).on('click', '#customerList li', function() {
            ...
            var customerId = parts[parts.length - 1];
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $.each(data, function(index, product) {
                        ...
                        $('#tableProduct tbody').append('<tr><td style="max-width: 150px">' + product.product_name + '</td><td>' +  "<img src='/product/"+product.image+"' width='160px' height='240px'> "+ '</td><td>' + product.product_id + '</td><td>' +
        ...
        function updateTotalAmount() {
            ...
            $('#tableProduct tbody tr').each(function() {
                ...
                $(this).find('td:eq(7)').text(formatMoney(totalSum));
            });
            ...
            $('input[name="perQuantity"]').val(perQuantity.join(', '));
            $('input[name="perDiscount"]').val(perDiscount.join(', '));
